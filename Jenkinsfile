pipeline {
    ...
    post {
        ...
        unsuccessful {
            emailext attachLog: true, body: 'See the attached log bellow', subject: 'Build $BUILD_NUMBER has failed', to: 'renfe22+jenkins@gmail.com'
        }
        fixed {
            emailext attachLog: true, body: 'See the attached log bellow', subject: 'Build is fine!!!', to: 'renfe22+jenkins@gmail.com'
        }
    }
